...
import styles from "./styles/ComponentsWrapToImage.module.scss";
import OrbitPicture from "../misc/ImageOrbitView";

export const ComponentsWrapToImage = ({ image, children, radius = 10, gap = -50 }) => {
