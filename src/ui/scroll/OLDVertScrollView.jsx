...
import styles from "./styles/OldVertScrollView.module.scss";
...
import { useNavStack } from "../../contexts/NavigationButtonsStack.jsx";
...
export const VertScrollSection = ({
  Header,
  children,
  sticky,
  narrow,
...
export const VerticalScrollView = ({
  children,
  trackVelocity = true,
  trackScrollPercent,
  staggerStart = false,
